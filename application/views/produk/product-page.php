    ...
    <div class="container dark-grey-text mt-5">
      ...
      <div class="row d-flex justify-content-center wow fadeIn">
        ...
        <div class="col-md-6 mb-4">
          ...
          <img src="<?=base_url('assets/images/produk/' . $produk['gambar_produk'])?>" style="max-width: 420px; max-height: 480px;" height="420" width="420"
							 id="bigPicture"
							 class="img-fluid zoom mb-4" alt="">
					<hr>
					<a href="#">
						<img src="<?=base_url('assets/images/produk/' . $produk['gambar_produk'])?>"
								 id="mainPicture" data-src="<?=base_url('assets/images/produk/' . $produk['gambar_produk'])?>"
								 style="border-style: solid; border-color: #2a6496; width: 120px; height: 120px;" height="120" width="120" class="img-fluid" alt="">
					</a>
					<a href="#">
					<?php if($produk['gambar_tambahan'] != NULL): ?>
						<img src="<?=base_url('assets/images/produk/' . $produk['gambar_tambahan'])?>"
								 id="addonPicture" data-src="<?=base_url('assets/images/produk/' . $produk['gambar_tambahan'])?>"
								 style="border-style: solid; border-color: #2a6496; width: 120px; height: 120px;" height="120" width="120" class="img-fluid" alt="">
					<?php endif; ?>
					</a>
          <!--  -->
