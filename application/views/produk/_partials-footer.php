<style>
	...
	.footer1 { width:100%; background-color:#263238; min-height:250px; padding:10px 0px 25px 0px ;}
	.pt2 { padding-top:40px ; margin-bottom:20px ;}
	.footer1 p { font-size:13px; color:#CCC; padding-bottom:0px; margin-bottom:8px;}
