        ...
        <div class="right_col" role="main"> <!-- Mulai Konten -->
					<div class="">
						...
						<div class="animated flipInY col-lg-4 col-md-4 col-sm-6 col-xs-12">
							...
							<h3>Total Seller</h3>
							<p>Menampilkan seluruh penjual.</p>
							</div>
						</div>
						<div class="animated flipInY col-lg-4 col-md-4 col-sm-6 col-xs-12">
							<div class="tile-stats">
							...
							<h3>Bulan Ini</h3>
							<p>Menampilkan jumlah penjual baru pada bulan ini.</p>
							</div>
						</div>
						<div class="animated flipInY col-lg-4 col-md-4 col-sm-6 col-xs-12">
							<div class="tile-stats">
							...
							<h3>Hari Ini</h3>
							<p>Menampilkan jumlah penjual baru pada hari ini.</p>
							</div>
						</div>
						</div>
							...
							<div class="col-md-12 col-sm-12 col-xs-12">
									<div class="x_panel">
										...
										<div class="x_content">
											...
											Menampilkan seluruh data penjual pada Toko Batik.
											</p>
											<table id="datatable-keytable" class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="datatable-keytable_info" style="position: relative;">
												...
												foreach ($sellers as $key) :  ?>
													<tr>
														...
														<a role="menuitem" tabindex="-1" href="#" onclick="set_url('<?= site_url('dashboard/admin/delete_sellers/' . encrypt_url($key['id_user']))  ?>')"
															id="btnHapus" data-toggle="modal" data-target="#kt_modal_1">Hapus Seller</a>
														
														<?php if($key['is_active'] == 1): ?>
															|
														<a role="menuitem" tabindex="-1" href="#" onclick="set_url1('<?= site_url('dashboard/admin/nonaktif_sellers/' . encrypt_url($key['id_user']))  ?>')"
															id="btnNonaktif" data-toggle="modal" data-target="#kt_modal_2">Nonaktifkan Seller</a>
														<?php else: ?>
															|
														<a role="menuitem" tabindex="-1" href="#" onclick="set_url2('<?= site_url('dashboard/admin/aktifkan_sellers/' . encrypt_url($key['id_user']))  ?>')"
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							...
							<div class="modal-body">
								<p>Anda yakin ingin menghapus data Seller ini?</p>
							</div>
				...
				<div class="modal fade" id="kt_modal_2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							...
							<div class="modal-body">
								<p>Anda yakin ingin mengnonaktifkan Seller ini?</p>
							</div>
							<div class="modal-footer">
								<button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
				...
				<div class="modal fade" id="kt_modal_3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							...
							<div class="modal-body">
								<p>Anda yakin ingin mengirim email pengaktifan Seller ini?</p>
							</div>
							<div class="modal-footer">
								<button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
