                                        ...
                                        <td class="text-center">
                                            <li role="presentation" class="dropdown" style="list-style: none;">
                                                ...
                                                <ul id="menu6" class="dropdown-menu animated fadeInDown" role="menu">
                                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="#" class="btnNonaktif" onclick="set_url('<?= site_url('dashboard/seller/deactive_category/' . encrypt_url($key['id_cat']))  ?>')" data-ket="meng nonaktifkan" data-toggle="modal" data-target="#kt_modal_1">
                                                        Nonaktifkan Kategori</a>
                                                    </li>
                                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="#" class="btnHapus" onclick="set_url('<?= site_url('dashboard/seller/delete_category/' . encrypt_url($key['id_cat']))  ?>')" data-ket="menghapus" data-toggle="modal" data-target="#kt_modal_1">
                                                        Hapus Kategori</a>
                                                    </li>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <li role="presentation" class="dropdown" style="list-style: none;">
                                                ...
                                                <ul id="menu6" class="dropdown-menu animated fadeInDown" role="menu">
                                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="#" class="btnAktif" onclick="set_url('<?= site_url('dashboard/seller/reactive_category/' . encrypt_url($key['id_cat']))  ?>')" data-ket="mengaktifkan" data-toggle="modal" data-target="#kt_modal_1">
                                                        Aktifkan Kategori</a>
                                                    </li>
                                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="#" class="btnHapus1" onclick="set_url('<?= site_url('dashboard/seller/delete_category/' . encrypt_url($key['id_cat']))  ?>')" data-ket="menghapus" data-toggle="modal" data-target="#kt_modal_1">
                                                        Hapus Kategori</a>
                                                    </li>
    ...
    <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog modal-lg">
        ...
        <div class="modal-header">
          ...
          <div class="modal-body">
            <form method="POST" action="<?= base_url('dashboard/seller/updateCat') ?>">
    ...
    <div class="modal modal-parente fade" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form method="POST" action="<?= base_url('dashboard/seller/updateCatParent') ?>">
