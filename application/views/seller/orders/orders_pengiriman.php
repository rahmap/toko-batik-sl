...
<html lang="en">
  ...
  <body class="nav-md">
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							...
							<div class="modal-body">
								...
								<form method="POST" action="<?= base_url('dashboard/seller/updateResi') ?>">
    ...
    <script>
			$(document).ready(function(){
				...
				$('.sett_detail').on('click', function(){
					...
					if($(this).data('notif') == ''){ //Set btn send notif
						$('#send-notif').show();
						$('#send-notif').attr('href', "<?= base_url() ?>" + 'dashboard/seller/remiderUserKonfirmasi/'+ id_orders);
					} else {
						$('#send-notif').hide();
					}
         		 ...
         		 $.ajax({  
							url: "<?= base_url() ?>" + 'dashboard/seller/setOrderItem',  
							method:'POST',  
          ...
          let url = "<?php echo base_url('dashboard/seller/hapusResi/') ?>";
          console.log(url)
