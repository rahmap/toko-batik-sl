            ...
            <div class="row">
							...
							<div class="col-md-12 col-sm-12 col-xs-12">
								<div class="x_panel">
									...
									<div class="x_content">
										<p class="text-muted font-13 m-b-30">
											Data pemesanan yang dibatalkan oleh seller dengan alasan tertentu.
										</p>
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							...
							<div class="modal-body">
								...
								<form method="POST" action="<?= base_url('dashboard/seller/batalkanPesanan') ?>">
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							...
							<div class="modal-body">
								...
								<form method="POST" action="<?= base_url('dashboard/seller/inputResi') ?>">
